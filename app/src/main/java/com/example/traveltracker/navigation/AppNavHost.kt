...
fun AppNavHost(navController: NavHostController) {
    NavHost(
        ...
        composable(LoginDestination.LoginScreen.route) { LoginRoute(onLoggedIn = {
            navController.navigate(HomeDestination.HomeScreen.route) { popUpTo(WelcomeDestination.WelcomeScreen.route) { inclusive = true } }
        }) }
        composable(RegisterDestination.RegisterScreen.route) { RegisterRoute(onRegistered = {
            navController.navigate(LoginDestination.LoginScreen.route) { popUpTo(WelcomeDestination.WelcomeScreen.route) }
        }) }

        composable(WelcomeDestination.WelcomeScreen.route) { WelcomeScreen(
        ...
        composable(HomeDestination.HomeScreen.route) { MapRoute(onLogout = {
