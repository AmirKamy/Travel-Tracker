...
@NonNullApi
public class TimetrackerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TimetrackerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
