...
@NonNullApi
public class TraveltrackerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public TraveltrackerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
