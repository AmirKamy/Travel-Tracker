...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>baseJunit</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidTools</b> with value <b>31.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxComposeCompiler</b> with value <b>2.1.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidxNavigation</b> with value <b>2.8.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>baseJunit</b> with value <b>4.13.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBaseJunit() { return getVersion("baseJunit"); }
        ...
        /**
         * Version alias <b>foundationLayoutAndroid</b> with value <b>1.6.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ksp</b> with value <b>2.1.20-2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roomPaging</b> with value <b>2.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final LinkerPluginAccessors paccForLinkerPluginAccessors = new LinkerPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.linker</b>
         */
        public LinkerPluginAccessors getLinker() {
            return paccForLinkerPluginAccessors;
        }
    ...
    public static class LinkerPluginAccessors extends PluginFactory {
        private final LinkerAndroidPluginAccessors paccForLinkerAndroidPluginAccessors = new LinkerAndroidPluginAccessors(providers, config);

        public LinkerPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.linker.android</b>
         */
        public LinkerAndroidPluginAccessors getAndroid() {
            return paccForLinkerAndroidPluginAccessors;
        }

    }

    public static class LinkerAndroidPluginAccessors extends PluginFactory {
        private final LinkerAndroidApplicationPluginAccessors paccForLinkerAndroidApplicationPluginAccessors = new LinkerAndroidApplicationPluginAccessors(providers, config);
        private final LinkerAndroidLibraryPluginAccessors paccForLinkerAndroidLibraryPluginAccessors = new LinkerAndroidLibraryPluginAccessors(providers, config);

        public LinkerAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>linker.android.feature</b> with plugin id <b>linker.android.feature</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getFeature() { return createPlugin("linker.android.feature"); }

        /**
         * Plugin provider for <b>linker.android.hilt</b> with plugin id <b>linker.android.hilt</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHilt() { return createPlugin("linker.android.hilt"); }

        /**
         * Plugin provider for <b>linker.android.room</b> with plugin id <b>linker.android.room</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getRoom() { return createPlugin("linker.android.room"); }

        /**
         * Group of plugins at <b>plugins.linker.android.application</b>
         */
        public LinkerAndroidApplicationPluginAccessors getApplication() {
            return paccForLinkerAndroidApplicationPluginAccessors;
        }

        /**
         * Group of plugins at <b>plugins.linker.android.library</b>
         */
        public LinkerAndroidLibraryPluginAccessors getLibrary() {
            return paccForLinkerAndroidLibraryPluginAccessors;
        }

    }

    public static class LinkerAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public LinkerAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>linker.android.application</b> with plugin id <b>linker.android.application</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("linker.android.application"); }

        /**
         * Plugin provider for <b>linker.android.application.compose</b> with plugin id <b>linker.android.application.compose</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("linker.android.application.compose"); }

    }

    public static class LinkerAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public LinkerAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>linker.android.library</b> with plugin id <b>linker.android.library</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("linker.android.library"); }

        /**
         * Plugin provider for <b>linker.android.library.compose</b> with plugin id <b>linker.android.library.compose</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("linker.android.library.compose"); }
